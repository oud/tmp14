...
class DemandeXRMResourceIT {
    ...
    void getAllDemandeXRMS() throws Exception {
        ...
        restDemandeXRMMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(demandeXRM.getId().toString())));
    }
    ...
    void getDemandeXRM() throws Exception {
        ...
        restDemandeXRMMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(demandeXRM.getId().toString()));
    }
    ...
    void getNonExistingDemandeXRM() throws Exception {
        // Get the demandeXRM
        restDemandeXRMMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingDemandeXRM() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        demandeXRM.setId(UUID.randomUUID());
    ...
    void deleteDemandeXRM() throws Exception {
        ...
        restDemandeXRMMockMvc
            .perform(delete(ENTITY_API_URL_ID, demandeXRM.getId().toString()).accept(MediaType.APPLICATION_JSON))
