...
class TelephoneResourceIT {
    ...
    void getAllTelephones() throws Exception {
        ...
        restTelephoneMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(telephone.getId().toString())))
    ...
    void getTelephone() throws Exception {
        ...
        restTelephoneMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(telephone.getId().toString()))
    ...
    void getNonExistingTelephone() throws Exception {
        // Get the telephone
        restTelephoneMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deleteTelephone() throws Exception {
        ...
        restTelephoneMockMvc
            .perform(delete(ENTITY_API_URL_ID, telephone.getId().toString()).accept(MediaType.APPLICATION_JSON))
