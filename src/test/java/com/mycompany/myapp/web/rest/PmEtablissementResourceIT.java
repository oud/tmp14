...
class PmEtablissementResourceIT {
    ...
    void getAllPmEtablissements() throws Exception {
        ...
        restPmEtablissementMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(pmEtablissement.getId().toString())))
    ...
    void getPmEtablissement() throws Exception {
        ...
        restPmEtablissementMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(pmEtablissement.getId().toString()))
    ...
    void getNonExistingPmEtablissement() throws Exception {
        // Get the pmEtablissement
        restPmEtablissementMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNonExistingPmEtablissement() throws Exception {
        long databaseSizeBeforeUpdate = getRepositoryCount();
        pmEtablissement.setId(UUID.randomUUID());
    ...
    void deletePmEtablissement() throws Exception {
        ...
        restPmEtablissementMockMvc
            .perform(delete(ENTITY_API_URL_ID, pmEtablissement.getId().toString()).accept(MediaType.APPLICATION_JSON))
