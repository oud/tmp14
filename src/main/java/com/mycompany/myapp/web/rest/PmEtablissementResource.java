...
public class PmEtablissementResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<PmEtablissementDTO> getPmEtablissement(@PathVariable("id") UUID id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deletePmEtablissement(@PathVariable("id") UUID id) {
