...
describe('PmEntreprise Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { pmEntreprise: () => of({ id: '880bba1e-bb12-4c88-9b95-d5613c75d70c' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load pmEntreprise on init', async () => {
      ...
      // THEN
      expect(instance.pmEntreprise()).toEqual(expect.objectContaining({ id: '880bba1e-bb12-4c88-9b95-d5613c75d70c' }));
    });
  });
