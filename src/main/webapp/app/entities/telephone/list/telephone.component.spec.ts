...
import { sampleWithRequiredData } from '../telephone.test-samples';
...
describe('Telephone Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'e879c833-557b-49fd-adcd-693dde08741f' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'a6517588-46ec-4c6b-8a66-a22dffe5ccaa' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.telephones()[0]).toEqual(expect.objectContaining({ id: 'e879c833-557b-49fd-adcd-693dde08741f' }));
  });

  describe('trackId', () => {
    it('should forward to telephoneService', () => {
      const entity = { id: 'e879c833-557b-49fd-adcd-693dde08741f' };
      jest.spyOn(service, 'getTelephoneIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTelephoneIdentifier).toHaveBeenCalledWith(entity);
