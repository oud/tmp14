...
describe('Telephone Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { telephone: () => of({ id: 'e879c833-557b-49fd-adcd-693dde08741f' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load telephone on init', async () => {
      ...
      // THEN
      expect(instance.telephone()).toEqual(expect.objectContaining({ id: 'e879c833-557b-49fd-adcd-693dde08741f' }));
    });
  });
