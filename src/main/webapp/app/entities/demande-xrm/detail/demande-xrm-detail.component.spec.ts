...
describe('DemandeXRM Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { demandeXRM: () => of({ id: '7509a767-d309-4aad-8b30-f53f87a9522e' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load demandeXRM on init', async () => {
      ...
      // THEN
      expect(instance.demandeXRM()).toEqual(expect.objectContaining({ id: '7509a767-d309-4aad-8b30-f53f87a9522e' }));
    });
  });
