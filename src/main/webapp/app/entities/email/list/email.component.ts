...
import { EmailService, EntityArrayResponseType } from '../service/email.service';
...
export class EmailComponent implements OnInit {
  ...
  trackId = (item: IEmail): string => this.emailService.getEmailIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.emails().length === 0) {
            ...
            this.emails.set(this.refineData(this.emails()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.emails.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IEmail[]): IEmail[] {
