...
describe('MiseEnGestion Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { miseEnGestion: () => of({ id: '452e40d0-5f12-48c7-afc0-c7b9e17d12de' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load miseEnGestion on init', async () => {
      ...
      // THEN
      expect(instance.miseEnGestion()).toEqual(expect.objectContaining({ id: '452e40d0-5f12-48c7-afc0-c7b9e17d12de' }));
    });
  });
