...
describe('Adresse Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { adresse: () => of({ id: 'f8aa52d9-cf31-47aa-88cc-e8ed0ef692e0' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load adresse on init', async () => {
      ...
      // THEN
      expect(instance.adresse()).toEqual(expect.objectContaining({ id: 'f8aa52d9-cf31-47aa-88cc-e8ed0ef692e0' }));
    });
  });
