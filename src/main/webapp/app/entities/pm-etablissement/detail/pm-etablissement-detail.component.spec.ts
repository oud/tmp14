...
describe('PmEtablissement Management Detail Component', () => {
          ...
          [
            {
              ...
              resolve: { pmEtablissement: () => of({ id: '86096998-fd76-4295-bf45-d21d61001919' }) },
            },
          ],
  ...
  describe('OnInit', () => {
    it('should load pmEtablissement on init', async () => {
      ...
      // THEN
      expect(instance.pmEtablissement()).toEqual(expect.objectContaining({ id: '86096998-fd76-4295-bf45-d21d61001919' }));
    });
  });
