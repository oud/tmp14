...
describe('PmEtablissement Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('should call DemandeXRM query and add missing value', () => {
      const pmEtablissement: IPmEtablissement = { id: '2e45e341-6e4f-4aa4-9f20-f30827c7f085' };
      const demandeXRM: IDemandeXRM = { id: '7509a767-d309-4aad-8b30-f53f87a9522e' };
      pmEtablissement.demandeXRM = demandeXRM;

      const demandeXRMCollection: IDemandeXRM[] = [{ id: '7509a767-d309-4aad-8b30-f53f87a9522e' }];
  ...
  describe('save', () => {
    it('should call update service on save for existing entity', () => {
      ...
      const pmEtablissement = { id: '86096998-fd76-4295-bf45-d21d61001919' };
  ...
  describe('Compare relationships', () => {
    describe('compareDemandeXRM', () => {
      it('should forward to demandeXRMService', () => {
        ...
        const entity2 = { id: 'fced0371-8868-41b9-8ca9-cf6d07c55a1e' };
